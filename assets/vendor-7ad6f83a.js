 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qe=Lc;function Uc(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i=Object.assign({name:gn,automaticDataCollectionEnabled:!1},e),s=i.name;if(typeof s!="string"||!s)throw we.create("bad-app-name",{appName:String(s)});if(n||(n=Es()),!n)throw we.create("no-options");const r=yt.get(s);if(r){if(vt(n,r.options)&&vt(i,r.config))return r;throw we.create("duplicate-app",{appName:s})}const a=new Gl(s);for(const c of vn.values())a.addComponent(c);const l=new Fc(n,i,a);return yt.set(s,l),l}function Bc(t=gn){const e=yt.get(t);if(!e&&t===gn&&Es())return Uc();if(!e)throw we.create("no-app",{appName:t});return e}function q(t,e,n){var i;let s=(i=kc[t])!==null&&i!==void 0?i:t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),a=e.match(/\s|\//);if(r||a){const l=[`Unable to register library "${s}" with version "${e}":`];r&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&a&&l.push("and"),a&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Te.warn(l.join(" "));return}re(new K(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hc="firebase-heartbeat-database",zc=1,Ge="firebase-heartbeat-store";let Zt=null;function Ns(){return Zt||(Zt=Ps(Hc,zc,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Ge)}catch(n){console.warn(n)}}}}).catch(t=>{throw we.create("idb-open",{originalErrorMessage:t.message})})),Zt}async function Vc(t){try{const n=(await Ns()).transaction(Ge),i=await n.objectStore(Ge).get(xs(t));return await n.done,i}catch(e){if(e instanceof Z)Te.warn(e.message);else{const n=we.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Te.warn(n.message)}}}async function mi(t,e){try{const i=(await Ns()).transaction(Ge,"readwrite");await i.objectStore(Ge).put(e,xs(t)),await i.done}catch(n){if(n instanceof Z)Te.warn(n.message);else{const i=we.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Te.warn(i.message)}}}function xs(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */q(Xc,Kc,"app");const Rs="@firebase/installations",xn="0.6.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ws=new Map;function js(t,e){const n=Rt(t);$s(n,e),dd(n,e)}function $s(t,e){const n=Ws.get(t);if(n)for(const i of n)i(e)}function dd(t,e){const n=ud();n&&n.postMessage({key:t,fid:e}),fd()}let Ee=null;function ud(){return!Ee&&"BroadcastChannel"in self&&(Ee=new BroadcastChannel("[Firebase] FID Change"),Ee.onmessage=t=>{$s(t.data.key,t.data.fid)}),Ee}function fd(){Ws.size===0&&Ee&&(Ee.close(),Ee=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hd="firebase-installations-database",pd=1,_e="firebase-installations-store";let Qt=null;function Rn(){return Qt||(Qt=Ps(hd,pd,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(_e)}}})),Qt}async function wt(t,e){const n=Rt(t),s=(await Rn()).transaction(_e,"readwrite"),r=s.objectStore(_e),a=await r.get(n);return await r.put(e,n),await s.done,(!a||a.fid!==e.fid)&&js(t,e.fid),e}async function Gs(t){const e=Rt(t),i=(await Rn()).transaction(_e,"readwrite");await i.objectStore(_e).delete(e),await i.done}async function Lt(t,e){const n=Rt(t),s=(await Rn()).transaction(_e,"readwrite"),r=s.objectStore(_e),a=await r.get(n),l=e(a);return l===void 0?await r.delete(n):await r.put(l,n),await s.done,l&&(!a||a.fid!==l.fid)&&js(t,l.fid),l}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xs="installations",Rd="installations-internal",Ld=t=>{const e=t.getProvider("app").getImmediate(),n=xd(e),i=xt(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},kd=t=>{const e=t.getProvider("app").getImmediate(),n=xt(e,Xs).getImmediate();return{getId:()=>Ad(n),getToken:s=>Pd(n,s)}};function Dd(){re(new K(Xs,Ld,"PUBLIC")),re(new K(Rd,kd,"PRIVATE"))}Dd();q(Rs,xn);q(Rs,xn,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Du(t,e){const n=await ir(t,{},async()=>{const i=Ze({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=t.config,a=sr(t,s,"/v1/token",`key=${r}`),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",nr.fetch()(a,{method:"POST",headers:l,body:i})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function Mu(t,e){return le(t,"POST","/v2/accounts:revokeToken",Q(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pr(t,e=[]){let n;switch(t){case"Browser":n=xi(U());break;case"Worker":n=`${xi(U())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Qe}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wr(t,e,n=!1){const i="signIn",s=await yr(t,i,e),r=await be._fromIdTokenResponse(t,i,s);return n||await t._updateCurrentUser(r.user),r}async function gf(t,e){return wr(ce(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dh(t,e){const n=ce(t),i=await vf(n,{token:e,returnSecureToken:!0}),s=await be._fromIdTokenResponse(n,"signIn",i);return await n._updateCurrentUser(s.user),s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function br(t){const e=ce(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Mh(t,e,n){const i=ce(t),s={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};n&&yf(i,s,n),await Et(i,s,"getOobCode",af)}async function Fh(t,e,n){const i=ce(t),a=await Et(i,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",hf).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&br(t),c}),l=await be._fromIdTokenResponse(i,"signIn",a);return await i._updateCurrentUser(l.user),l}function Uh(t,e,n){return gf(ae(t),Fe.credential(e,n)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&br(t),i})}function wf(t,e,n,i){return ae(t).onIdTokenChanged(e,n,i)}function bf(t,e,n){return ae(t).beforeAuthStateChanged(e,n)}function Bh(t){return ae(t).signOut()}const Tt="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cr(){return typeof X().WorkerGlobalScope<"u"&&typeof X().importScripts=="function"}async function Af(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Pf(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function Nf(){return Cr()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
