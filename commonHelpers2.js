import"./assets/support-ukraine-482a9db5.js";import{c as u}from"./assets/vendor-7ad6f83a.js";let o=b();f();const y=document.querySelector(".list-books-shopping"),g=document.querySelector(".container-loader"),d=document.querySelector(".ul-pagination");window.addEventListener("load",async e=>{e.preventDefault(),o.size===0?(document.querySelector(".empty-shop-list").style.display="flex",d.style.display="none"):(await p(0,3),m(),h()),k("Shopping List"),g.style.display="none"});async function m(){const e=o.size,i=e/3;let t=`
