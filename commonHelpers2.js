import"./assets/support-ukraine-1205dd54.js";import{i as y}from"./assets/vendor-7539751a.js";let o=b();f();const u=document.querySelector(".list-books-shopping"),g=document.querySelector(".container-loader"),c=document.querySelector(".ul-pagination");window.addEventListener("load",async e=>{e.preventDefault(),o.size===0?(document.querySelector(".empty-shop-list").style.display="flex",c.style.display="none"):(await p(0,3),m(),v()),L("Shopping List"),g.style.display="none"});async function m(){const e=o.size,i=e/3;let t=`
