import{s as w,a as L}from"./assets/amazon-cc4b8648.js";import{i as u}from"./assets/vendor-7539751a.js";let s=I();f();const y=document.querySelector(".list-books-shopping"),p=document.querySelector(".container-loader"),c=document.querySelector(".ul-pagination");window.addEventListener("load",async e=>{e.preventDefault(),s.size===0?(document.querySelector(".empty-shop-list").style.display="flex",c.style.display="none"):(await g(0,3),m(),v()),b("Shopping List"),p.style.display="none"});async function m(){const e=s.size,i=e/3;let a=`
